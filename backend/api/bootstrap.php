...
try { $pdo = new PDO('mysql:host='.env_value('DB_HOST','127.0.0.1').';port='.env_value('DB_PORT','3306').';dbname='.env_value('DB_DATABASE','logbook').';charset=utf8mb4', env_value('DB_USERNAME','root'), env_value('DB_PASSWORD',''), [PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION, PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC]); } catch (Throwable $e) { http_response_code(503); respond(false, 'Database connection is unavailable.'); }
